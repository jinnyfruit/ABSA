...
entity_property_model_path ="/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/koBERT/saved_models/category_extraction"
polarity_model_path = "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/koBERT/saved_models/polarity_classification"
...
def train_sentiment_analysis():
    ...
    for _ in trange(epochs, desc="Epoch"):
        ...
        if do_eval:
            ...
            acc, F1 = evaluation(label_list, pred_list, len(polarity_id_to_name))
            wandb.log({"Ent acc - eval": acc})
            wandb.log({"Ent F1 score - eval": F1})
        ...
        print("Entity_Property_Epoch: ", epoch_step)
        print("Average train loss: {}".format(avg_train_loss))
        wandb.log({"Polarity_Avg train loss": avg_train_loss})
        ...
        if do_eval == "True":
            ...
            acc, F1 = evaluation(label_list, pred_list, len(polarity_id_to_name))
            wandb.log({"Pol acc - eval": acc})
            wandb.log({"Pol F1 score - eval": F1})
