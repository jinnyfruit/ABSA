...
'''
import os
os.system('sh chmod +x train.sh | ./train.sh')
'''
...
training_phase = ["train_data",
                    ...
                    "dev_data"]
data_path = [
                "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/data/nikluge-sa-2022-train.jsonl",
                "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/data/nikluge-sa-2022-test.jsonl",
                "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/data/nikluge-sa-2022-dev.jsonl"
            ]
train_path = "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/data/nikluge-sa-2022-train.jsonl"
dev_path = "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/data/nikluge-sa-2022-dev.jsonl"
test_path = "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/data/nikluge-sa-2022-dev.jsonl"
...
entity_property_model_path ="/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/koBERT/saved_models/default_path"
polarity_model_path = "/home/nlplab/Devlopment/2022_korean_AI/JiWoo/BASELINE/koBERT/saved_models/default_path"
...
def evaluation(y_true, y_pred, label_len, property):
    ...
    wandb.log({property + "f1_score: ": f1_score})
...
def train_sentiment_analysis():
    ...
    for _ in trange(epochs, desc="Epoch"):
        ...
        wandb.log({"Entity property Avg train loss": avg_train_loss})
        ...
        property = "train - entity_property "
...
def test_sentiment_analysis():
    ...
    polarity_model = RoBertaBaseClassifier(len(polarity_id_to_name), len(tokenizer))
    polarity_model.load_state_dict(torch.load(polarity_model_path, map_location=device))
    polarity_model.to(device)
    polarity_model.eval()
    ...
    wandb.log({"Test F1 result": evaluation_f1(test_data, pred_data)})
    
    property = "polarity test"
